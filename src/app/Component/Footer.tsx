          ...
          <div className="flex flex-wrap md:text-left text-center -mb-10 -mx-4">
            <div className="lg:w-1/6 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10">
                ...
                {/* </li>
          <li>We have clothes that suits your style and which you’re proud to wear. From women to men.
            <a className="text-[#fafafa]">Get 10% off your first order</a>
          </li>
          <li>
